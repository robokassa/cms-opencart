...
$_['entry_order_pending'] 	= 'Статус заказа в ожидании подтверждения';
$_['entry_order_processing'] = 'Статус заказа для подтверждения оплаты';
$_['entry_order_canceled']  = 'Статус заказа для отмены холдирования';
