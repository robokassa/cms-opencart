...
$_['entry_hold_pending_status'] = 'Статус после холдирования';
$_['entry_hold_confirm_status'] = 'Статус для подтверждения холда';
$_['entry_hold_cancel_status'] = 'Статус для отмены холда';
...
$_['help_hold_statuses']     = 'При переводе заказа из статуса холдирования в статус подтверждения или отмены модуль выполнит соответствующую операцию в Robokassa.';
...
$_['error_hold_statuses']   = 'Для холдирования выберите три разных существующих статуса заказа.';
